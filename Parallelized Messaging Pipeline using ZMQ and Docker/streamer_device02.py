...
def main():
    ...
    ZMQ_END_OF_PIPELINE_RECEIVER_DEVICE_ADDRESS = os.environ["ZMQ_END_OF_PIPELINE_RECEIVER_DEVICE_ADDRESS"]
    ...
    try:
        ...
        end_of_pipeline_reciever.bind(ZMQ_END_OF_PIPELINE_RECEIVER_DEVICE_ADDRESS)
